        ...
        <div className={"min-h-screen max-h-screen min-w-screen flex justify-center bg-gradient-to-b from-gray-100 to-gray-300  items-center"}>
            ...
            <div className={"w-[50%] h-full"}>
                <div className="title flex flex-col justify-center items-center">
                    ...
                    <h1 className="text-8xl font-permanentmarker">Connexion</h1>
                    <p className={"text-gray-600 font-medium"}>Utilisez la méthode de connexion la plus adaptée</p>
                    ...
                    <form action={async () => {
                        ...
                        <button type="submit" className="w-full text-xl mt-3 py-3 px-8 font-medium text-gray-100 flex items-center rounded-md shadow-lg bg-gray-800 border border-gray-300 hover:scale-105 transition-all duration-300 hover:bg-gray-900">
